window.DSMB_TRAININGS = [
  ...
  {
    id: 'checkin-document-study-team',
    title: 'Access and Revise DSMB Documents - Study Team',
    group: 'Documents',
    role: 'Study Team Member',
    route: '/dsmb/:dsmbId/dsmb-details',
    duration: '8 steps',
    summary: 'Open published DSMB materials, check out an editable document, and check in the revised version.',
    steps: [
      {
        targetId: 'nav-safety',
        screen: 'dashboard',
        title: 'Open DSMB/ISM/SO',
        body: 'Study Team Members access DSMB materials after the meeting materials are published and permissions allow visibility.',
        expectedAction: 'Click Safety Monitoring Oversight',
        successState: 'DSMB list opens'
      },
      {
        targetId: 'entity-row',
        screen: 'dsmb-list',
        title: 'Open the DSMB workspace',
        body: 'Select the DSMB record associated with the study materials you need to view.',
        expectedAction: 'Click Training DSMB Board 001',
        successState: 'DSMB Details opens'
      },
      {
        ...
        screen: 'details',
        title: 'Open Meetings',
        body: 'Expand the Meetings panel to see the published meeting row.',
        expectedAction: 'Click Meetings',
        successState: 'Meetings panel opens'
      },
      {
        targetId: 'published-meeting-row',
        screen: 'details',
        title: 'Confirm the published meeting',
        body: 'Published meeting materials are the trigger for Study Team access to permitted DSMB documents.',
        expectedAction: 'Click the published meeting',
        successState: 'Published meeting is identified'
      },
      {
        targetId: 'documents-panel',
        screen: 'details',
        title: 'Open Documents',
        body: 'Document visibility depends on agenda permissions and document category.',
        expectedAction: 'Click Documents',
        successState: 'Documents panel opens'
      },
      {
        targetId: 'published-document-row',
        screen: 'documents',
        title: 'Open the permitted document',
        body: 'Use the document row to view or download the material for reference.',
        expectedAction: 'Click Protocol_CRS2408_Deidentified.pdf',
        successState: 'Document row is selected'
      },
      {
        targetId: 'document-checkout',
        screen: 'documents',
        title: 'Check out for revision',
        body: 'Check out should be used only when the Study Team has been asked to make revisions or corrections.',
      ...
      },
      {
        ...
        screen: 'documents',
        title: 'Check in the revised file',
        body: 'After editing offline, check in the revised document so CROMS stores the updated version and metadata.',
  ...
  {
    id: 'checkin-document-program-officer',
    title: 'Access and Revise DSMB Documents - Program Officer',
    group: 'Documents',
    role: 'Program Officer',
    route: '/dsmb/:dsmbId/dsmb-details',
    duration: '8 steps',
    summary: 'Open published DSMB materials, review a document, and use check-out/check-in when edits are required.',
    steps: [
      {
        targetId: 'nav-safety',
        screen: 'dashboard',
        title: 'Open DSMB/ISM/SO',
        body: 'Program Officers access DSMB documents and meetings from the DSMB/ISM/SO module.',
        expectedAction: 'Click DSMB/ISM/SO',
        successState: 'Program Officer DSMB list opens'
      },
      {
        targetId: 'entity-row',
        screen: 'dsmb-list',
        title: 'Open the assigned DSMB',
        body: 'Select the assigned DSMB record before reviewing meeting materials.',
        expectedAction: 'Click Training DSMB Board 001',
        successState: 'DSMB Details opens'
      },
      {
        ...
        screen: 'details',
        title: 'Open Meetings',
        body: 'Expand the Meetings panel before selecting the published meeting.',
        expectedAction: 'Click Meetings',
        successState: 'Meetings panel opens'
      },
      {
        targetId: 'published-meeting-row',
        screen: 'details',
        title: 'Review the published meeting',
        body: 'Documents become available after the meeting has been published and study documents are submitted.',
        expectedAction: 'Click the published meeting',
        successState: 'Published meeting is identified'
      },
      {
        ...
        screen: 'details',
        title: 'Open Documents',
        body: 'Meeting session type, agenda permissions, and document category can affect what the Program Officer sees.',
        expectedAction: 'Click Documents',
        successState: 'Documents panel opens'
      },
      {
        ...
        body: 'View or download the document for reference before deciding whether edits are needed.',
        expectedAction: 'Click Protocol_CRS2408_Deidentified.pdf',
        successState: 'Document row is selected'
      },
      {
        targetId: 'document-checkout',
        screen: 'documents',
        title: 'Check out when edits are required',
        body: 'Program Officers should reserve check-out for documents that need revision, such as meeting summaries or outcome letters.',
        expectedAction: 'Click Check Out',
        successState: 'Document is checked out'
      },
      {
        targetId: 'document-checkin',
        screen: 'documents',
        title: 'Check in the revised document',
        body: 'Check in uploads the revised file and captures the document metadata for the new version.',
        expectedAction: 'Click Check In',
        successState: 'Document is checked in'
      }
    ]
  ...
  {
    id: 'checkin-document-dsmb-member',
    title: 'Access and Revise DSMB Documents - DSMB Member',
    group: 'Documents',
    role: 'DSMB Member',
    route: '/dsmb/:dsmbId/dsmb-details',
    duration: '8 steps',
    summary: 'Access DSMB meeting materials and practice check-out/check-in for document revisions.',
    steps: [
      {
        targetId: 'nav-safety',
        screen: 'dashboard',
        title: 'Open DSMB/ISM/SO',
        body: 'DSMB Members use the DSMB/ISM/SO area to access assigned DSMB meeting materials.',
        expectedAction: 'Click Safety Monitoring Oversight',
        successState: 'DSMB list opens'
      },
      {
        ...
        screen: 'dsmb-list',
        title: 'Open the DSMB record',
        body: 'Select the DSMB workspace associated with the meeting materials.',
        expectedAction: 'Click Training DSMB Board 001',
        successState: 'DSMB Details opens'
      },
      {
        ...
        screen: 'details',
        title: 'Open Meetings',
        body: 'Expand the Meetings panel to locate the published meeting.',
        expectedAction: 'Click Meetings',
        successState: 'Meetings panel opens'
      },
      {
        targetId: 'published-meeting-row',
        screen: 'details',
        title: 'Find the published meeting',
        body: 'Published meetings make permitted DSMB materials available for member review.',
        expectedAction: 'Click the published meeting',
        successState: 'Published meeting is identified'
      },
      {
        ...
        screen: 'details',
        title: 'Open Documents',
        body: 'Check-In / Check-Out controls editing status; it does not approve, validate, or finalize document content.',
        expectedAction: 'Click Documents',
        successState: 'Documents panel opens'
      },
      {
      ...
      },
      {
        ...
        body: 'Check out the document only when you need to make an offline revision.',
        expectedAction: 'Click Check Out',
        successState: 'Document is checked out'
      },
      {
        ...
        screen: 'documents',
        title: 'Check in the revised document',
        body: 'Upload the revised file through check-in so CROMS records the updated version.',
        expectedAction: 'Click Check In',
        successState: 'Document is checked in'
      }
    ]
